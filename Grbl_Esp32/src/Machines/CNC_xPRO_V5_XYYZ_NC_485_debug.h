...
#define MACHINE_NAME "CNC_xPRO_V5_XYYZ_NC_485_debug"
...
#define N_AXIS 3 
#define MAX_AXIS 3
#define VFD_DEBUG_MODE 1 
#define VFD_DEBUG_MODE2	1
/***************************DO NOT CHANGE*******************/
...
// Default configuration - assuming screw TR8*8 screw driven machine in XYYZ config
 ...
 //this setting should be roughly 40-75% of the run current
...
//Control Safety Door Switch
 ...
 #	  define INVERT_CONTROL_PIN_MASK B00111110